...
public class RestaurantBuilder {
	...
	public static void main(String[] args) {
		Restaurant firstRestaurant = new Restaurant("CLaude Monet", 100, "Bandery st. 17", 30, 50.50, 1250.40, "French", 1);
		...
		for (int i = 0; i <= 3; ++i) {
			Restaurant loopOfRestaurants = new Restaurant("CLaude Monet", 100 + 5 * i, "Bandery st. 17", 30 + 2 * i, 50.50, 1250.40, "French", 1 + i);
			arrayOfRestaurants[i] = loopOfRestaurants;
		}
